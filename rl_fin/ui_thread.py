...
class UiThread:
    ...
    def _on_draw(self, dd: DrawData):
        ...
        if dd.grid_lines is not None:
            gl.glLineWidth(1.0)
            gl.glColor3f(0.412, 0.412, 0.412)
            for y in np.nditer(dd.grid_lines):
                gl.glBegin(gl.GL_LINES)
                gl.glVertex3f(0, y, 0.0)
                gl.glVertex3f(1, y, 0.0)
                gl.glEnd()
            ...
            for y in np.nditer(dd.grid_lines):
                gl.glBegin(gl.GL_LINES)
                gl.glVertex3f(0.995, y, 0.0)
                gl.glVertex3f(1.0, y, 0.0)
                gl.glEnd()
